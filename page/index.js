const
	...
	buildPage = ( src , type , title , description , author , favicon , facebook , keywords , elements ) => `${createVar( 'title' , title )}${createVar( 'description' , description )}${createVar( 'author' , author )}\n` +
			type === 'html' ?
